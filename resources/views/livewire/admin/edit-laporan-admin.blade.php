                    ...
                    <form wire:submit.prevent="update" class="form form-vertical" enctype="multipart/form-data">
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group has-icon-left">
                                        <label for="respon">Respon Laporan</label>
                                        <div class="position-relative">
                                            <textarea id="respon" wire:model="respon" rows="5" class="form-control @error('respon') is-invalid @enderror" placeholder="Tuliskan respon laporan untuk informasi ke pelapor"></textarea>
                                            <div class="form-control-icon">
                                                <i class="bi bi-info-circle"></i>
                                            </div>
                                            @error('respon')
